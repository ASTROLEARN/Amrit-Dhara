...
export function MetalContaminationSlider() {
          ...
          <div className="flex justify-between items-start">
            <div>
              <CardTitle className="text-lg flex items-center gap-2">
                ...
                {currentData.metal} Contamination
              </CardTitle>
              <CardDescription>
                High concentration of {currentData.metal} detected in {currentData.samples} sample(s)
              </CardDescription>
            </div>
        ...
        <CardContent className="space-y-4">
          <div>
            <div className="flex justify-between items-center mb-2">
              ...
              <Badge variant="outline">{currentData.whoStandard} mg/L</Badge>
            </div>
            <div className="flex justify-between items-center mb-2">
              <span className="text-sm font-medium">Current Level</span>
              <Badge variant={currentData.severity === 'High' ? 'destructive' : 'secondary'}>
                {currentData.concentration} mg/L
              </Badge>
            </div>
            <Progress 
              value={(currentData.concentration / currentData.whoStandard) * 100} 
              className="h-2"
            />
          </div>
          ...
          <div>
            ...
            <p className="text-sm font-medium text-blue-600 mb-1">{currentData.recommendation}</p>
            <p className="text-xs text-gray-600 mb-2">Comprehensive treatment for various heavy metals</p>
            <div className="flex gap-2">
              <Badge variant="secondary" className="text-xs">
                Effectiveness: {currentData.effectiveness}
              </Badge>
          ...
          <div>
            ...
            <p className="text-sm font-medium text-green-600 mb-1">{currentData.alternative}</p>
            <p className="text-xs text-gray-600 mb-2">Eco-friendly solution using hyperaccumulator plants</p>
            <div className="flex gap-2">
              <Badge variant="secondary" className="text-xs">
                Effectiveness: {currentData.alternativeEffectiveness}
              </Badge>
              <Badge variant="outline" className="text-xs">
                Cost: {currentData.alternativeCost}
              </Badge>
            </div>
          </div>
          ...
          <div className="flex justify-between items-center">
            ...
            <span className="text-xs text-gray-500">
              {currentIndex + 1} / {contaminationData.length}
            </span>
